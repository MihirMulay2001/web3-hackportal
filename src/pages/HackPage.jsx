    ...
    <div className="hackpgwrapper">
      <HackHeader
        ...
        judgelist={[
          {
            imglink:
              "https://www.macworld.com/wp-content/uploads/2021/10/steve-jobs-2-1.jpg?quality=50&strip=all",
            name: "Steve Jobs",
            title: "CEO of Apple",
          ...
          {
            imglink:
              "https://assets.entrepreneur.com/content/3x2/2000/1652298519-GettyImages-13276855511.jpg",
            name: "Mark Zuck",
            title: "CEO of Meta",
            email: "mark@meta.com",
            linkedin: "Mark Zuck",
          ...
          {
            imglink:
              "https://d.newsweek.com/en/full/1548436/rick-morty-elon-tusk.jpg?w=1600&h=1600&l=55&t=21&q=88&f=8ee9ccf4be0bcb709cc54809d1722cd7",
            name: "Elon Tusk",
            title: "CEO of Tesla",
                ...
                <AccordionDetails>
                  <div className="submitcard">
                    ...
                    <div className="submitright">
                      ...
                      ></iframe>
                      <TextField
                        placeholder="Eg. https://www.youtube.com/watch?v=MnrJzXM7a6o"
                        label={"Video link"}
                        sx={{ width: "100%" }}
                        onChange={(e) => {
                ...
                <AccordionDetails>
                  <div className="submitcard">
                    ...
                    >
                      ...
                      />
                      <TextField
                        label={"Team lead's wallet id"}
                        sx={{ width: "50%" }}
                        onChange={(e) => {
                          setTeamlead_wallet_id(e.target.value);
                        }}
                      />
                      <div
                        className="paybtn"
